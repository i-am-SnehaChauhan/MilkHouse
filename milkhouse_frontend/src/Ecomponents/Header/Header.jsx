                    ...
                    <ul className={`${styles.navMenu} ${isActive ? styles.active : ''}`}>
                        <li onClick={removeActive}>
                            <Container to='/dairy' style={{ fontSize: '17px', fontFamily: 'Roboto', fontWeight: '450' }}>
                                <Typography style={{ color: 'white', fontSize: '17px', fontWeight: '450', ':hover': { color: 'yellow' } }}>
                                    Home
                                </Typography>
                            </Container>
                        </li>
                        <li onClick={removeActive}>
                            <Container to={isAuthenticated ? '/account' : '/signin'}>
                                <PersonIcon style={{ color: 'white' }} />
                                <Typography style={{ color: 'white', fontSize: '17px', fontWeight: '450' }}>
